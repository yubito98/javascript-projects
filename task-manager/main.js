    ...
    tasks.forEach(item =>{
        ...
        <li class="list-group-item list-task-item">
            ...
            <div class="task-buttons">
                ...
                <svg class="task-btn"  width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="task-btn" onclick="deleteTask(event)" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function deleteTask(event){
    event.preventDefault();
    let taskItem = event.target.parentNode.parentNode.parentNode; 
